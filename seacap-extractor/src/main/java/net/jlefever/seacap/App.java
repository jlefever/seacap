...
import net.jlefever.seacap.churn.db.StoreChanges;
import net.jlefever.seacap.churn.db.StoreCommits;
import net.jlefever.seacap.ctags.GetTags;
import net.jlefever.seacap.ctags.TreeTagBuilder;
import net.jlefever.seacap.ctags.db.StoreRootTag;
import net.jlefever.seacap.ctags.db.UpdateLinenos;
import net.jlefever.seacap.db.RefreshMatViews;
import net.jlefever.seacap.db.StoreRepo;
import net.jlefever.seacap.depends.GetDepsFromDepends;
import net.jlefever.seacap.depends.StoreDeps;
import net.jlefever.seacap.git.GitDriver;
import net.jlefever.seacap.ir.EntityHasherImpl;
...
public class App
{
    public static void main(String[] args) throws IOException, InterruptedException
    {
        ...
        // RuntimeExcetion when storing changes
            ...
            throws IOException, InterruptedException
    {
        ...
        var flatChanges = new GetChanges(repo.getDir(), repoRev, pathFilter, 750, 30).execute();
