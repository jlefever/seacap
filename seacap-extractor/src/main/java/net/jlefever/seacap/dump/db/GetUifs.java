...
import net.jlefever.seacap.dump.db.dtos.UifDto;
import net.jlefever.seacap.dump.models.antipatterns.Uif;
import net.jlefever.seacap.dump.models.antipatterns.UifSummary;
