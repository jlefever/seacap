...
import net.jlefever.seacap.clique.CliqueFinder;
import net.jlefever.seacap.clique.GraphImpl;
import net.jlefever.seacap.dump.models.DepEdge;
import net.jlefever.seacap.dump.models.antipatterns.Clq;
import net.jlefever.seacap.dump.models.antipatterns.ClqSummary;
