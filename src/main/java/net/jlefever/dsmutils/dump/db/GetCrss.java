...
import net.jlefever.dsmutils.dump.db.dtos.CrsDto;
import net.jlefever.dsmutils.dump.models.antipatterns.Crs;
import net.jlefever.dsmutils.dump.models.antipatterns.CrsSummary;
